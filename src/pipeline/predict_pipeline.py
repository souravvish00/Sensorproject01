...
class PredictionPipeline:
    def __init__(self, request: request):
        ...
        self.prediction_pipeline_config = PredictionPipeline()
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            input_dataframe : pd.DataFrame = pd.read.csv(input_dataframe_path)

            input_dataframe = input_dataframe.drop(columns="unname:0") if "unname:0" in input_dataframe.columns else input_dataframe
