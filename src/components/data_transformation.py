...
from sklearn.preprocessing import RobostScaler, FunctionTransformer
...
class DataTransformation:
    def __init__(self, feature_store_path):
        self.feature_store_file_path = feature_store_path
    ...
    def get_data_trasformer_objects(self):

        try:
            imputer_step = ('imputer' , SimpleImputer(strategy='constant' , fill_value=0))
            scaler_step = ('scaler' , RobostScaler())
    ...
    def initiate_data_trasformaton(self):
        ...
        try:
            ...
            preprocessor = self.get_data_trasformer_objects()

            X_train_scaled = preprocessor.fit_transform(X_train)
            X_test_scaled = preprocessor.transform(X_test)

            preprocessor_path = self.data_trasformation_config.transformed_object_file_path
